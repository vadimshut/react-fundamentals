...
const fetchLogin = createAsyncThunk('courses/fetchLogin', async (body, { rejectWithValue }) => {
	try {
...
const fetchLogout = createAsyncThunk('courses/fetchLogout', async (_, { rejectWithValue }) => {
	try {
